    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="text-white">AES</h3>

            </div>
            <div class="card-body">
                <div class="row">
                    <form method="post" action="cifrarAes.php" enctype="multipart/form-data">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="clave" id="clave" placeholder="La clave con la que desea cifrar" required class="form-control">
                        </div>
                        <br>
                ...
                <br>
                <div class="row">
                    <form method="post" action="descifrarAes.php" enctype="multipart/form-data">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="clavemsj">Clave:</label>
                            <input type="text" name="clavemsj" id="clavemsj" placeholder="La clave con la que fue cifrado el registro" required class="form-control">
                        </div>
                        <br>
            ...
            <div class="card-footer">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM mensajes_aes";
                        $result = mysqli_query($conn->conectardb(), $sql);

                        while ($mostrar = mysqli_fetch_array($result)) {
                        ?>
                            <tr>
                                <td><?php echo $mostrar['idaes'] ?></td>
