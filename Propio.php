...
<body>
    ...
    <div class="container">
        <h1>Metodo de Cifrado Propio</h1>
        <br>
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="text-white">Cifrado Propio</h3>

            </div>
            <div class="card-body">
                <div class="row">
                    <form method="post" action="cifrarPropio.php" enctype="multipart/form-data">
                        <div class="col-md-6">
                ...
                <br>
                <div class="row">
                    <form method="post" action="descifrarPropio.php" enctype="multipart/form-data">
                        <div class="col-md-6">
            ...
            <div class="card-footer">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM propio";
                        $result = mysqli_query($conn->conectardb(), $sql);

                        while ($mostrar = mysqli_fetch_array($result)) {
                        ?>
                            <tr>
                                <td><?php echo $mostrar['idpropio'] ?></td>
