    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="text-white">Hash V1 - sha1</h3>

            </div>
            <div class="card-body">
                <div class="row">
                    <form method="post" action="cifrarHashv1.php" enctype="multipart/form-data">
                        <div class="col-md-6">
                ...
                <br>
                <div class="row">
                    <form method="post" action="descifrarHashv1.php" enctype="multipart/form-data">
                        <div class="col-md-6">
            ...
            <div class="card-footer">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM hashv1";
                        $result = mysqli_query($conn->conectardb(), $sql);

                        while ($mostrar = mysqli_fetch_array($result)) {
                        ?>
                            <tr>
                                <td><?php echo $mostrar['idh1'] ?></td>
