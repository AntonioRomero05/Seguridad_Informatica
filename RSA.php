...
<body>
    ...
    <div class="container">
        <h1>Metodo de Cifrado Asimetrico</h1>
        <br>
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="text-white">RSA</h3>

            </div>
            <div class="card-body">
                <div class="row">
                    <form method="post" action="cifrarRSA.php" enctype="multipart/form-data">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="llave" id="llave" placeholder="La llave con la que desea cifrar" required class="form-control">
                        </div>
                        <br>
                        <button class="btn btn-secondary" type="submit">Cifrar</button>
                    </form>

                </div>
                <br>
                <div class="row">
                    <form method="post" action="descifrarRSA.php" enctype="multipart/form-data">
                        <div class="col-md-6">
                            <label for="numeroreg">Numero del Mensaje:</label>
                            <input type="number" name="numeroreg" id="numeroreg" placeholder="El numero del registro que desea descifrar" required class="form-control">
                        </div>
                        <br>
                        <div class="col-md-6">
                            <label for="llavereg">Clave asociada a la llave:</label>
                            <input type="text" name="llavereg" id="llavereg" placeholder="Clave asociada a la llave de cifrado" required class="form-control">
                        </div>
                        <br>
                        <button class="btn btn-warning" type="submit">Descifrar</button>
                    </form>
            ...
            <div class="card-footer">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM mensaje_rsa";
                        $result = mysqli_query($conn->conectardb(), $sql);

                        while ($mostrar = mysqli_fetch_array($result)) {
                        ?>
                            <tr>
                                <td><?php echo $mostrar['idrsa'] ?></td>
